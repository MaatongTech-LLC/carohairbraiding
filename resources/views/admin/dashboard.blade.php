                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        Customers
                                        <h2 class="counter" style="visibility: visible;">{{ $clients }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        Services
                                        <h2 class="counter" style="visibility: visible;">{{ $services }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        Work Coming
                                        <h2 class="counter" style="visibility: visible;">{{ $booking }}</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card border-bottom border-4 border-0 border-danger">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <span class="counter" style="visibility: visible;">1200</span>
                                    </div>
                                </div>
                            </div>
                        </div>
