!function (e) {
        ...
        e(t).length > 0 && e(t).each((function () {
            ...
            e(this).find(t).each((function () {
                e(this).on("click", (function () {
                    ...
                    t.length && (event.preventDefault(), e("html, body").stop().animate({scrollTop: t.offset().top - 10}, 1e3))
                }))
            }))
        }))
    }
    ...
    if (e(window).on("load", (function () {
        ...
        var s = document.querySelector(".scroll-top"), a = document.querySelector(".scroll-top path"),
            o = a.getTotalLength();
        ...
        var n = function () {
            var t = e(window).scrollTop(), s = e(document).height() - e(window).height(), n = o - t * o / s;
    ...
    var i = e(".hero-slider-6"), r = e(".progress"), l = e(".pagingInfo1"), c = e(".slider__label"),
        d = e(".pagingInfo2");
    ...
    u.on("init", (function (t, s, a) {
        var o = e(s.$slides[s.currentSlide]), n = o.next(), i = o.next().next(), r = o.prev(), l = o.prev().prev();
    ...
    var p, h, f, v = ".ajax-contact", g = '[name="email"]', m = e(".form-messages");
    ...
    function b() {
        ...
        (function () {
            ...
            return s
        })() && jQuery.ajax({url: e(v).attr("action"), data: t, type: "POST"}).done((function (t) {
    ...
    (new WOW).init(), e.fn.asTab = function (t) {
        ...
        e(this).each((function () {
            ...
            function r() {
                var n = t.find(s.tabButton + ".active"), i = n.css("height"), r = n.css("width"),
        ...
        e(this).each((function () {
            var t = e(this), s = t.data("top"), a = t.data("right"), o = t.data("bottom"), n = t.data("left");
            t.css({
                top: s,
                right: a,
                bottom: o,
        ...
        e(this).each((function () {
            ...
            var o = setInterval((function () {
                var e = (new Date).getTime(), n = s - e, i = Math.floor(n / 864e5), r = Math.floor(n % 864e5 / 36e5),
                    l = Math.floor(n % 36e5 / 6e4), c = Math.floor(n % 6e4 / 1e3);
        ...
        t.append('<span class="indicator"></span>');
        var o = t.find(".indicator");
        if (s.length) var n = s; else if (a.length) n = a;

        function i() {
            var s = t.find(".active"), a = s.css("height"), n = s.css("width"), i = s.position().top + "px",
