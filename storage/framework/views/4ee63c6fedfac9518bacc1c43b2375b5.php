    ...
    <div class="position-relative iq-banner">
        ...
        <div class="iq-navbar-header" style="height: 215px;">
            ...
            <div class="iq-header-img">
                <img src="<?php echo e(asset('admin/assets/images/dashboard/top-header.png')); ?>" alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX">
            </div>
    ...
    <footer class="footer bg-dark">
        <div class="footer-body">
            <div class="right-panel">
                &copy;<script>document.write(new Date().getFullYear())</script> Caro Hair Braiding Admin App made with
                <span class="">
                  ...
                  </span> by <a href="https://maatonggroup.com/usa/" target="_blank">MaatongTech LLC USA</a>.
            </div>
        </div>
    </footer>
    <!-- Footer Section End -->
...
<?php /**PATH C:\Users\Loic\Desktop\Maatong Group\Client Projects\Caro Hair Braiding\carohairbraiding\resources\views/admin/layouts/main.blade.php ENDPATH**/ ?>