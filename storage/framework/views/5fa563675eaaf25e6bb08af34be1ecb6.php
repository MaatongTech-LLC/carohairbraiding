                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <div class="header-logo">
                            <a href="/"><img height="80" width="140" src="<?php echo e(asset('assets/img/logo.png')); ?>"
                        ...
                        <nav class="main-menu d-none d-lg-inline-block">
                            <ul>
                                <li class="item-active">
                                    <a class="<?php echo e(request()->routeIs('home') ? 'active' : ''); ?>" href="/">Home</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class="<?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>" href="/contact">Contact Us</a>
                                </li>
                            </ul>
                        </nav>
...
<?php /**PATH C:\Users\Loic\Desktop\Maatong Group\Client Projects\Caro Hair Braiding\carohairbraiding\resources\views/partials/header.blade.php ENDPATH**/ ?>