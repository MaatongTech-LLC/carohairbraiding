...
<section class="price-area overflow-hidden space">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade active show" id="nav-step1" role="tabpanel">
                            <div class="price-box-wrapper style2">
                                <?php $__empty_1 = true; $__currentLoopData = $data['womenServices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="price-box">
                                        <div class="price-box_wrapp">
                                            <div class="price-box_content">
                                                <h4 class="box-title">
                                                    <a href="<?php echo e(route('booking', $service->id)); ?>"><?php echo e($service->name); ?></a>
                                                </h4>
                                                <p class="price-box_desc">
                                                    Caro Hair Braiding
                                                </p>
                                            </div>
                                            <span class="price-box_price">$<?php echo e($service->price); ?></span>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="nav-step2" role="tabpanel">
                            <div class="price-box-wrapper style2">
                                <?php $__empty_1 = true; $__currentLoopData = $data['menServices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="price-box">
                                        <div class="price-box_wrapp">
                                            <div class="price-box_content">
                                                <h4 class="box-title">
                        ...
                        <div class="tab-pane fade" id="nav-step3" role="tabpanel">
                            <div class="price-box-wrapper style2">
                                <?php $__empty_1 = true; $__currentLoopData = $data['kidsServices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="price-box">
                                        <div class="price-box_wrapp">
                                            <div class="price-box_content">
                                                <h4 class="box-title">
                            ...
                            <div class="form-group col-12">
                                <select name="service_id" id="subject" class="form-select" required>
                                    ...
                                    <optgroup label="Women">
                                        <?php $__currentLoopData = $data['womenServices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($service->id); ?>">
                                                <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($service->image)); ?>" alt=""> <span><?php echo e(ucwords($service->name)); ?></span>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </optgroup>
                                    <optgroup label="Men">
                                        <?php $__currentLoopData = $data['menServices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($service->id); ?>">
                                                <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($service->image)); ?>" alt=""> <span><?php echo e(ucwords($service->name)); ?></span>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <optgroup label="Kids">
                                        <?php $__currentLoopData = $data['kidsServices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($service->id); ?>">
                                                <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($service->image)); ?>" alt=""> <span><?php echo e(ucwords($service->name)); ?></span>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="shape-mockup jump" data-top="0%" data-right="0%">
        <img src="<?php echo e(asset('assets/img/shape/flower_1_11.png')); ?>" alt="shape" />
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Loic\Desktop\Maatong Group\Client Projects\Caro Hair Braiding\carohairbraiding\resources\views/home.blade.php ENDPATH**/ ?>