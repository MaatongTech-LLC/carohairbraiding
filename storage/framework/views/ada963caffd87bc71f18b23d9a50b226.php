    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>" aria-current="page" href="<?php echo e(route('admin.dashboard')); ?>">
                        <i class="icon">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('admin.booking.*') ? 'active' : ''); ?>" data-bs-toggle="collapse" href="#sidebar-booking" role="button" aria-expanded="false" aria-controls="sidebar-booking">
                        <i class="icon">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-booking" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.booking.index') ? 'active' : ''); ?>" href="<?php echo e(route('admin.booking.index')); ?>">
                                <i class="icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.booking.calendar') ? 'active' : ''); ?>" href="<?php echo e(route('admin.booking.calendar')); ?>">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
...
<?php /**PATH C:\Users\Loic\Desktop\Maatong Group\Client Projects\Caro Hair Braiding\carohairbraiding\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>